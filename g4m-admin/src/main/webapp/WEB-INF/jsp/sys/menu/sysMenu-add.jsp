...
<form class="form-horizontal" id="sysMenu_add_form" role="form">
	<div class="row">
		<div class="col-xs-6">
	...
	<div class="row">
		...
		<div class="col-xs-6">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-level">级别:</label>
				<div class="col-sm-9">
					<input id="form-field-level" name="level" value="${sysMenu.level}" class="form-control" type="text">
				</div>
			</div>
		</div>
	</div>
