...
<script type="text/javascript">
	...
	$('.page-content-area').ace_ajax('loadScripts',[],function() {
		var columns=[
				...
				{"data" : "fieldMenuName",className: "center"}, 
	...
	$('#sysTableFieldMain_aceDels').on('click',function() {
		aceDels("确定删除？","${server}sys/tablefield/del?${_csrf.parameterName}=${_csrf.token}","sysTableFieldMain");
	});
</script>