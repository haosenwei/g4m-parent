...
<form class="form-horizontal" id="sysTableField_add_form" role="form">
	<div class="row">
		<div class="col-xs-6">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select id="form-field-tableId" name="tableId" class="form-control">
					 	<g:select entityName="sysTable" valueKey="tableId" valueName="menuName" valuea="${sysTableField.tableId}"/>
					</select>
				</div>
			</div>
		</div>
