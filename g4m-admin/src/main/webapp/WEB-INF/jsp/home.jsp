...
<html lang="en">
	<head>
		...
		<!-- <link rel="stylesheet" href="/static/ace/assets/css/pace.css" />
		<script data-pace-options='{ "ajax": true, "document": true, "eventLag": false, "elements": false }' src="/static/ace/components/PACE/pace.js"></script> -->
		...
		<link rel="stylesheet" href="/static/ace/components/toastr/toastr.css" />
		
		<link rel="stylesheet" href="/static/assets/css/bootstrap-duallistbox.min.css" />
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<c:forEach var="obj" items="${sysMenuList}">
					<li class="">
						<c:if test="${obj.typeDic == '2' }">
						...
						<ul class="submenu">
							<c:forEach var="childobj" items="${obj.list}">
							<li class="">
								<a data-url="${childobj.url}" href="#${childobj.url}">
		...
		<!--[if !IE]> -->
		<script type="text/javascript" src="/static/ace/components/jquery/dist/jquery.js"></script>
		...
		<script type="text/javascript" src="/static/ace/components/bootstrap/dist/js/bootstrap.js"></script>

		<!-- ace scripts -->
		<script type="text/javascript" src="/static/ace/assets/js/ace.js"></script>
		<script type="text/javascript" src="/static/ace/assets/js/ace-elements.js"></script>

		<script type="text/javascript" src="/static/ace/components/datatables/media/js/jquery.dataTables.js"></script>
		<script type="text/javascript" src="/static/ace/components/_mod/datatables/jquery.dataTables.bootstrap.js"></script>
		<script type="text/javascript" src="/static/ace/components/bootbox.js/bootbox.js"></script>
		<script type="text/javascript" src="/static/ace/components/jquery-validation/dist/jquery.validate.js"></script>
		<script type="text/javascript" src="/static/ace/components/jquery-validation/dist/additional-methods.js"></script>
		<script type="text/javascript" src="/static/ace/components/toastr/toastr.min.js"></script>
		<script type="text/javascript" src="/static/ace/components/select2/dist/js/select2.js"></script>
		...
		$('.page-content-area').ace_ajax({
            ...
            default_url: 'main',//default url
            loading_icon: "fa fa-spin fa-spinner fa-5x orange"
		});
		</script>
